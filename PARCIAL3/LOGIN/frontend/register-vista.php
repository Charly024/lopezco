...
<div class="container-form">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h2>REGISTRATE</h2></div>
            
            <div class="user line-input">
                <label class="lnr lnr-envelope"></label>
                <input class="textbox" type="text" placeholder="Correo" name="correo">
            </div>
            <div class="user line-input">
            ...
            <div class="password line-input">
                <label class="lnr lnr-lock"></label>
                <input class="textbox" type="password" placeholder="Confirmar contraseña" name="clave2">
            </div>
